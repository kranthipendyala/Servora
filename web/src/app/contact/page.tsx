    ...
    <div className="min-h-screen bg-accent-200">
      ...
      <div className="container mx-auto px-4 py-12 md:py-16 max-w-5xl">
        <div className="grid md:grid-cols-3 gap-6">
          {/* Email card */}
          <div className="bg-white rounded-card p-6 shadow-xs border border-gray-100">
        ...
        {/* Contact form */}
        <div className="mt-8 bg-white rounded-card p-8 md:p-10 shadow-xs border border-gray-100">
