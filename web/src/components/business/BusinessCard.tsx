...
export default function BusinessCard({
  ...
  if (layout === "list") {
    return (
      <article className="bg-white rounded-2xl border border-surface-200 shadow-xs hover:shadow-md hover:border-primary-100 transition-all duration-200 overflow-hidden group">
      ...
      <Link href={`/business/${business.slug}`} className="block">
        <div className="relative h-40 overflow-hidden">
          ...
          <div className="absolute top-3 left-3 flex gap-1.5">
            {business.is_verified && (
              <span className="inline-flex items-center gap-1 px-2 py-1 rounded-lg bg-white/90 backdrop-blur-sm text-[10px] font-bold text-gray-700 shadow-xs">
                <svg className="w-3 h-3" fill="currentColor" viewBox="0 0 20 20">
                  <path
                    fillRule="evenodd"
                    d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"
          ...
          {business.rating ? (
            <div className="absolute bottom-3 right-3">
              <span className="inline-flex items-center gap-1 px-2 py-1 rounded-lg bg-white/90 backdrop-blur-sm text-xs font-bold text-gray-900 shadow-xs">
