    ...
    >
      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-14 md:h-16 gap-3 md:gap-4">
          ...
          >
            <div className="w-10 h-10 bg-gradient-to-br from-primary-500 to-primary-600 rounded-xl flex items-center justify-center shadow-xs group-hover:shadow-md transition-all duration-200">
            ...
            <div className="hidden sm:block">
              <span className="text-xl font-heading font-bold text-primary-500">
                Serv<span className="text-primary-700">ora</span>
              </span>
          ...
          <nav className="hidden md:flex items-center gap-1">
            ...
            {user ? (
              <Link
                href="/services"
                className="ml-2 inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary-600 text-white text-sm font-bold hover:bg-primary-800 transition-all shadow-xs hover:shadow-md"
              >
              ...
              <Link
                ...
                className="ml-2 inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary-600 text-white text-sm font-bold hover:bg-primary-700 transition-all shadow-xs hover:shadow-md"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {/* Mobile Search */}
        <div className="md:hidden pb-3 px-0">
          <SearchBar variant="header" />
        </div>
      </div>
          ...
          <nav className="container mx-auto px-4 py-4 flex flex-col gap-1">
            ...
            {user ? (
              ...
              <>
                ...
                <Link
                  href="/vendor/register"
                  className="mt-2 inline-flex items-center justify-center gap-2 px-5 py-3 rounded-xl bg-primary-600 text-white text-sm font-bold hover:bg-primary-700 transition-colors"
                  onClick={() => setMobileMenuOpen(false)}
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
